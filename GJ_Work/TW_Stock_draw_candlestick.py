...
#arguments
iuput_path  = '/Users/andy/TW_Stock_PriceData/'
output_path = "/Users/andy/TW_Stock_Image_64-32-201806-201905-by80/";
day = 80;  #default
pixel_width = 64;  #default
pixel_height = 32;  #default
begin = '2018-06-01'; #string, ex: "1991-02-07"; default is the first date in your data
end = '2019-05-31'; #string, ex: "1991-02-07"; default is the last date in your data
...
csvFile = [f for f in os.listdir(iuput_path) if os.path.isfile(os.path.join(iuput_path, f))]

for input_file in csvFile:
	data = pd.read_csv(iuput_path+input_file);
	#############################################
	...
	for i in range(0, data.shape[0]-day+1):
		...
		#save the picture
		plt.savefig(output_path+output_name+".png", dpi=96);
		plt.close(fig)